...
// Used to control the collection type (can be internal or external incoming and other combinations can support single audio and single video, external input for recording, UAV and other peripherals involved)
